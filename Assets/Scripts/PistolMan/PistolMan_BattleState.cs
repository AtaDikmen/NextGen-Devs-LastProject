...
public class PistolMan_BattleState : NpcState
{
    private PistolMan npc;

    public PistolMan_BattleState(NPC _npcBase, NpcStateMachine _stateMachine, string _animBoolName, PistolMan _npc) : base(_npcBase, _stateMachine, _animBoolName)
    {
        this.npc = _npc;
    }
